...
export const Header = forwardRef<HTMLDivElement, Props>(function index(props, ref) {
    return (
        <div className="fixed top-0 left-0 right-0 flex justify-between items-center z-10 mx-10 py-10 text-black">
            ...
            <a className="hidden lg:block" href="https://bit.ly/curpracode-booking" target="_blank"
            ...
            <div className={`!block lg:!hidden  ${styles.header}`}>
                <StickyMag>
                    <div className={styles.burger}>
                        <div ref={ref as React.Ref<HTMLDivElement>} className={styles.bounds}></div>
                    </div>
